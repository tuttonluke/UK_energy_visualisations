...
export async function initMap() {
    ...
    try {
        ...
        mapInstance.on('load', async () => {
            ...
            const solar_response = await fetch('http://127.0.0.1:8000/api/solar/solar');
            ...
            document.getElementById('status-dot').classList.replace('pulse', 'connected');
